...
public class ItemParamLov_DC {
    public ItemParamLov_DC() {
        super();
    }
    ...
    public void ProcessOU() throws AdfInvocationException {
     ...
     //   payloadTH.setRespId("50637");
      //  payloadTH.setRespAppId("101");
        ...
        GenericType payloadGT =  GenericTypeBeanSerializationHelper.toGenericType("ItemParamLov_WL.Types.process.TransactionHeader", payloadTH);
        ...
        try {
            resultGT =
                (GenericType) AdfmfJavaUtilities.invokeDataControlMethod("ItemParamLov_WL", null, "process", pnames,
                                                                         pvals, ptypes);
            resultGT = resultGT.getParent();
            Object provider = AdfmfJavaUtilities.getDataControlProvider("ItemParamLov_WL");
