...
public class ItemcatParamLov_DC {
    public ItemcatParamLov_DC() {
        super();
    }
    ...
    public void ProcessOU() throws AdfInvocationException {
        ...
        payloadTH.setCallingInterfaceName("INV");
     ...
     //   payloadTH.setRespId("50637");
      //  payloadTH.setRespAppId("101");
        ...
        GenericType payloadGT =  GenericTypeBeanSerializationHelper.toGenericType("ItemcatParamLov_WL.Types.process.TransactionHeader", payloadTH);
        ...
        try {
            resultGT =
                (GenericType) AdfmfJavaUtilities.invokeDataControlMethod("ItemcatParamLov_WL", null, "process", pnames,
                                                                         pvals, ptypes);
            //resultGT = resultGT.getParent();
            Object provider = AdfmfJavaUtilities.getDataControlProvider("ItemcatParamLov_WL");
           ...
           // Integer a = resultGT.getAttributeCount();
           // String a1 = resultGT.getAttribute(0).toString();
           // AddOU(resultGT.getAttribute(0).toString());
            for (int i = 0; i < (resultGT.getAttributeCount()); i++) {
                //GenericType entityGenericType = (GenericType) resultGT.getAttribute(i);
                //AddOU(entityGenericType.getAttribute(0).toString());
               AddOU(resultGT.getAttribute(i).toString());
            } 
        } catch (AdfInvocationException ex) {
